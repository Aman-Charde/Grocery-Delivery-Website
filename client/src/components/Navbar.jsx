...
//             {/* Mobile Menu */}
//             {open && (
//                 <div className="absolute top-[60px] left-0 w-full bg-white shadow-md py-4 flex flex-col items-start gap-2 px-5 text-sm md:hidden z-10">
    ...
    return (
        <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                <NavLink
                    to='/seller'
                    className="text-gray-600 border border-gray-400 rounded-full px-4 py-1 text-sm hover:bg-gray-100 transition"
                >
                    Seller Dashboard
                </NavLink>
