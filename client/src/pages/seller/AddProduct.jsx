...
const AddProduct = () => {
  ...
  return (
        <div className="no-scrollbar felx-1 h-[95vh] overflow-y-scroll flex flex-col justify-center">
            <form onSubmit={onSubmitHandler} className="md:p-10 p-4 space-y-5 max-w-lg">
                ...
                <button className="cursor-pointer px-8 py-2.5 bg-primary hover:bg-primary-dull transition text-white font-medium rounded">ADD</button>
            </form>
        </div>
  )
}
